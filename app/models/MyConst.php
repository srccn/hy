...
class MyConst {
	...
	public static $cols = array (
			...
			"q4" => "id,title,auth_by,auth_code,auth_year,auth_month,author,user_id,note,ref_url,attachment_name",
			"q5" => "id,title,author,auth_year,auth_month,publisher,user_id,note,ref_url,attachment_name",
	...
	public static $reportCols = array (
			...
			"q4" => "title,auth_by,auth_code,auth_year,auth_month,author,user_id",
			"q5" => "title,author,auth_year,auth_month,publisher,user_id",
